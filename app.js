...
function createItem(index_of_new_item) {
    ...
    setButton(completed_button, 'completed', index_of_new_item)
    let delete_button = document.createElement('button')
    setButton(delete_button, 'delete', index_of_new_item)
...
function setButton(button, text, index) {
    button.setAttribute('id', text + String(index))
